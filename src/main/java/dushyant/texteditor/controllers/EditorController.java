...
public class EditorController {
    ...
    public EditorController() {
        area = new StyledTextArea<>(ParStyle.EMPTY, (textFlow, parStyle) -> textFlow.setStyle(parStyle.toCss()),
                TextStyle.EMPTY.updateFontFamily("Calibri").updateFontSize(12),
                (textExt, textStyle) -> textExt.setStyle(textStyle.toCss()));
        ...
        familyCombo.getSelectionModel().select("Calibri");
        ...
        vBox.getStylesheets().add(getClass().getResource("/resources/css/rich-text.css").toExternalForm());
    }
